...
// Аннотация задаётся описанием соответствующего интерфейса с ключевым
// словом @interface
...
// В данном случае это поля класса.
...
// Это нужно для того, чтобы мы могли в процессе выполнения обращаться к
// классу через рефлексию.
